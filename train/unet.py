...
def create_unet(input_shape):
    ...
    #up4 = ZeroPadding2D(padding=((0, 1), (0, 1)))(up4)  # for test in grandes rousses domain
    conv3 = Cropping2D(cropping=((0, 1), (0, 1)))(conv3) # for test in grandes rousses domain
    print("debug")
    print("conv3")
    print(conv3)
    print("up4")
    ...
    2nd up
    '''
    conv2 = Cropping2D(cropping=((0, 1), (0, 1)))(conv2) # for test in grandes rousses domain
    print("debug")
    print("conv2")
    print(conv2)
    print("up3")
    ...
    1st up
    '''
    conv1 = Cropping2D(cropping=((0, 1), (0, 1)))(conv1) # for test in grandes rousses domain
