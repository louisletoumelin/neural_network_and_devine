...
class VisuMap:
    ...
    def plot_quiver(self, cm,
                    ...
                    edgecolor_arome="C1", figsize=(15, 10), edgecolor_observation="black", width=0.001,
        ...
        norm = MidPointNorm(midpoint=uv, vmin=0.5, vmax=6.5)
        ...
        save_figure(f"Map_wind_fields/{self.model}", exp=self.exp, svg=True)
